...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        creareDomenii: function (obj, default_text, callback) {
            ...
            h2 = $("<" + "input />", {
                ...
                "keydown": function (event) {
                    ...
                    if (key === 13) {
                        $.ajax({
                            type: 'post',
                            url: url + '/Universities/Create',
                            data: { id: " ", parent: tmp.parent, text: tmp.text },
                            success: function (result) {
                                if (result.Validare == true) {
        ...
        creareCategorii: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
        ...
        creareLocatii: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
        ...
        creareLanguage: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
        ...
        editDomenii: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
            ...
            h2 = $("<" + "input />", {
                ...
                "keydown": function (event) {
                    ...
                    if (key === 13) {
                        $.ajax({
                            type: 'post',
                            url: url + '/Universities/Edit/' + tmp.id,
                            data: { id: tmp.id, parent: tmp.parent, text: tmp.text },
                            success: function (result) {
                                if (result.Validare == true) {
                                    toastr.success(result.Message, { showDuration: 300 });
                                } else {
        ...
        editCategorii: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
        ...
        editLocatii: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
        ...
        editLanguage: function (obj, default_text, callback) {
            var rtl, w, a, s, t, h1, h2, fn, tmp;
            obj = this.get_node(obj);
            if (!obj) { return false; }
            if (this.settings.core.check_callback === false) {
    ...
    _i.className = 'fa fa-circle green jstree-checkbox';
    _i.setAttribute('role', 'presentation');
    $('.green').css("color", "#3c8dbc");
