...
namespace DependencyInjectionCrossLayer
{
    ...
    /// currently bin application folder. Only assemblies whose names matches
    /// certain patterns are investigated and an optional list of assemblies
    /// referenced by <see cref="AppDomainTypeFinder.AssemblyNames"/> are always investigated.
    /// </summary>
    public class BinAppTypeFinder : AppDomainTypeFinder
    {
        #region Fields
