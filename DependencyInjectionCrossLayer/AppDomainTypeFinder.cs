...
namespace DependencyInjectionCrossLayer
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>
        /// The list of starting names for assemblies to be ignored
        /// </summary>
        private string _assemblySkipLoadingPattern =
            "^System|^mscorlib|^Microsoft|^AjaxControlToolkit|^Antlr3|^Autofac|^AutoMapper|^Castle|^ComponentArt|^CppCodeProvider|^DotNetOpenAuth|^EntityFramework|^EPPlus|^FluentValidation|^ImageResizer|^itextsharp|^log4net|^MaxMind|^MbUnit|^MiniProfiler|^Mono.Math|^MvcContrib|^Newtonsoft|^NHibernate|^nunit|^Org.Mentalis|^PerlRegex|^QuickGraph|^Recaptcha|^Remotion|^RestSharp|^Rhino|^Telerik|^Iesi|^TestDriven|^TestFu|^UserAgentStringLibrary|^VJSharpCodeProvider|^WebActivator|^WebDev|^WebGrease|^nist|^Reactive|^NLog|^Windows|^vs|^More|^Oracle|^Splat|^struct";
        ...
        /// <summary>Gets or sets whether application should iterate assemblies in the app domain when loading application types. 
        ...
        /// For ease of use this defaults to match all but to increase performance you might want to configure 
        /// a pattern that includes assemblies and your own.</summary>
        /// <remarks>If you change this so that our assemblies arn't investigated 
        /// (e.g. by not including something like "^Kepler|..." you may break core functionality.</remarks>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into application.
        /// </returns>
